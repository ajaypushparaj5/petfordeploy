      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-600 text-sm">
              Connecting pets with their forever homes since 2023.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/wishlist" className="text-gray-600 hover:text-primary text-sm">Wishlist</Link></li>
              <li><Link to="/my-pets" className="text-gray-600 hover:text-primary text-sm">My Pets</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-primary text-sm">Pet Care Guides</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary text-sm">Adoption Tips</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-600 text-sm">support@petmagic.com</li>
        ...
        <div className="border-t border-gray-100 mt-8 pt-8">
          <p className="text-gray-500 text-sm text-center">
            &copy; {new Date().getFullYear()} PetMagic. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
